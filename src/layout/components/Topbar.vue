<template>
  <div class="top-nav">
    <div class="log">Legend财务管理系统</div>
    <el-menu
      ...
      <div v-for="item in permission_routes" :key="item.path" class="nav-item">
        <app-link :to="resolvePath(item)">
          <el-menu-item
            v-if="!item.hidden"
            :index="item.path"
          ><b>{{ item.meta ? item.meta.title : item.children[0].meta.title }}</b></el-menu-item>
        </app-link>
      </div>
    </el-menu>
    ...
    <div class="right-menu">
      <el-dropdown class="avatar-container right-menu-item hover-effect" trigger="click">
        <div class="avatar-wrapper">
          <img :src="'https://ui-avatars.com/api/?length=1&name='+name" class="user-avatar">
